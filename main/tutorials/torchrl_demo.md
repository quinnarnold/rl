...
```
Collected batch: torch.Size([200]), reward: -7.85
Collected batch: torch.Size([200]), reward: -8.97
Collected batch: torch.Size([200]), reward: -8.36
Collected batch: torch.Size([200]), reward: -8.88
Collected batch: torch.Size([200]), reward: -9.21
```
...
```
Prioritized sample indices: tensor([76, 27, 91, 39, 96]) ...
```
