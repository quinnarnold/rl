...
```
First eval: {'eval/reward': -890.86083984375, 'eval/reward_std': 0.0, 'eval/num_episodes': 1, 'eval/episode_length': 200.0, 'eval/fps': 712.6254852418491, 'eval/step': 0}
```
...
```
Second eval: {'eval/reward': -1275.47900390625, 'eval/reward_std': 0.0, 'eval/num_episodes': 1, 'eval/episode_length': 200.0, 'eval/fps': 716.743548223208, 'eval/step': 1}
```
...
```
poll(timeout=30) returned: {'eval/reward': -1183.080810546875, 'eval/reward_std': 0.0, 'eval/num_episodes': 1, 'eval/episode_length': 200.0, 'eval/fps': 716.6897682058103, 'eval/step': 2}
```
...
```
Before weight update: {'eval/reward': -918.8175048828125, 'eval/reward_std': 0.0, 'eval/num_episodes': 1, 'eval/episode_length': 200.0, 'eval/fps': 499.6859074323005, 'eval/step': 0}
```
...
```
After weight update: {'eval/reward': -1478.6807861328125, 'eval/reward_std': 0.0, 'eval/num_episodes': 1, 'eval/episode_length': 200.0, 'eval/fps': 501.5158542377434, 'eval/step': 1}
```
...
```
With TensorDict weights: {'eval/reward': -1215.965576171875, 'eval/reward_std': 0.0, 'eval/num_episodes': 1, 'eval/episode_length': 200.0, 'eval/fps': 501.03313156993556, 'eval/step': 2}
```
...
```
Process backend: {'eval/reward': -1179.154296875, 'eval/reward_std': 0.0, 'eval/num_episodes': 1, 'eval/episode_length': 200.0, 'eval/fps': 653.1288235897844, 'eval/step': 0}
```
...
```
Logged to: /tmp/tmpim3he9ou/eval_demo/scalars/eval/reward.csv
0,-1219.498779296875
1,-1118.7216796875
2,-1331.8580322265625
```
