...
```
pkg_path /tmp/tmp32g8cmn0/model.pt2
tensor(1)
```
...
[torch.onnx] Optimize the ONNX graph... ✅
ONNX rollout took 609.8087 msec (total = 0.6098 sec since last reset).
TorchRL version took 1874.0416 msec (total = 1.8740 sec since last reset).
```
...
**Total running time of the script:** (0 minutes 23.129 seconds)
